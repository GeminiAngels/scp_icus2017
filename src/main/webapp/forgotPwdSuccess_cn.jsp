		...
		<div class="row" style="max-width:1170px;margin:0 auto;">
			<div class="col-md-12 no-padding">
				...
				<span style="float:right;" id="registerInfo">
					<button class="btn btn-success" onclick="javascript:index();">首页</button>
  	...
  	<div class="container login-form">
    	...
    	<div class="row wow fadeInUp animated">
			...
			<div class="col-sm-8 col-sm-offset-2">
				<div class="alert alert-success"><i class="fa fa-check" style="border:1px solid;border-radius: 100%"></i>  密码重置邮件已经发送到， ${resetPwdEmail} 请查收并处理！</div>
			</div>
			<div class="col-sm-8 col-sm-offset-2">
			</div>
			</form>
