    	...
    	<div class="row wow fadeInUp animated">
			...
			<div class="col-sm-4">
				...
				<div style="line-height:20px;">
					...
					<input type="text" id="sfbg_input" name="sfbg" style="margin-left:10px;width:263px;height:38px;line-height: 38px;" placeholder="Report Topics" disabled />
				</div>
				</div>
			</div>
			<div class="col-sm-4 col-sm-offset-2">
			...
			<div class="col-sm-8 col-sm-offset-2">
				<button id="registerBtn" name="submit" type="button" class="btn btn-primary btn-lg">Register Now</button>
			</div>
			</form>
		</div>
  	</div>
