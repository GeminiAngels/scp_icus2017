	...
	<div class="container">
		...
		<div class="collapse navbar-collapse appiNav">
			<ul class="nav navbar-nav">
				...
				<li><a href="index.jsp#callForPapers">征文通知 </a></li>
				<li><a href="index.jsp#workshop">研讨会</a></li>
				<li><a href="index.jsp#Keynote Speakers">主题报告</a></li>
				<li><a href="index.jsp#Invited Sessions">特邀报告</a></li>
				<li><a href="index.jsp#Submission">投稿</a></li>
				<li><a href="index.jsp#committee">组织架构</a></li>
				<li><a href="index.jsp#Download">资料下载</a></li>
				<li><a href="index.jsp#Venue">会场</a></li>
				<li id="registerInfo">
					<div class="btn-group">
...
<section id="contact" class="section">
	<div class="container register-form">
    	...
    	<div class="row wow fadeInUp animated">
			...
			<div class="col-sm-4 col-sm-offset-2">
				<div class="inputContainer">
				<label class="screen-reader-text">现场参会：</label>
				<div class="form-control" style="line-height:20px;">
					<label class="radio-inline">
			...
			<div class="col-sm-4">
				<div class="inputContainer">
				<label class="screen-reader-text">现场报告：</label>
